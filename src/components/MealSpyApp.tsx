...
import { Beer, LocateFixed, SlidersHorizontal, MapPin, Tag, ChevronDown, ChevronUp, Plus } from "lucide-react";
      ...
      <header className="sticky top-0 z-40 border-b border-[#2f2417]/10 bg-[#ff6b35] shadow-sm">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex gap-2">
            ...
            <Link
              href="/drinks"
              className="flex h-9 items-center gap-1.5 rounded-md border-2 border-white/30 bg-white/15 px-3 text-xs font-black text-white"
            >
        ...
        {!loading && filtered.length === 0 && (
          <div className="rounded-xl border-2 border-[#2f2417]/10 bg-white p-10 text-center">
            ...
            <p className="mt-1 text-sm font-bold text-black/50">
              ...
              <Link href="/list" className="text-[#ff6b35] underline">list your place</Link> to be first.
            </p>
          </div>
        )}
